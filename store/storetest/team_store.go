...
func testGetChannelUnreadsForAllTeams(t *testing.T, ss store.Store) {
	...
	c1 := &model.Channel{TeamId: m1.TeamId, Name: model.NewId(), DisplayName: "P2C", Type: model.CHANNEL_OPEN, TotalMsgCount: 100}
	store.Must(ss.Channel().Save(c1, -1))
	c2 := &model.Channel{TeamId: m2.TeamId, Name: model.NewId(), DisplayName: "P2C", Type: model.CHANNEL_OPEN, TotalMsgCount: 100}
...
func testGetChannelUnreadsForTeam(t *testing.T, ss store.Store) {
	...
	c1 := &model.Channel{TeamId: m1.TeamId, Name: model.NewId(), DisplayName: "P2C", Type: model.CHANNEL_OPEN, TotalMsgCount: 100}
	store.Must(ss.Channel().Save(c1, -1))
	c2 := &model.Channel{TeamId: m1.TeamId, Name: model.NewId(), DisplayName: "P2C", Type: model.CHANNEL_OPEN, TotalMsgCount: 100}
	store.Must(ss.Channel().Save(c2, -1))
